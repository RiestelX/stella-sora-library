import{p as e,L as d,q as p,w as m,t as h,M as x,v as u,S as f,x as y,y as g,a as l,O as j,i as b}from"./chunk-OIYGIGL5-CqnSy69x.js";import{c as n}from"./createLucideIcon-BiySaqhs.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const z=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 16v-4",key:"1dtifu"}],["path",{d:"M12 8h.01",key:"e9boi3"}]],E=n("info",z),R="/stella-sora-library/icons/game-icon.webp";function $(){const s=[{name:"Trekker",to:"/trekker",icon:e.jsx(L,{size:18})},{name:"Disc",to:"/disc",icon:e.jsx(_,{size:18})},{name:"Guide",to:"/guide",icon:e.jsx(w,{size:18})},{name:"Tier List",to:"/tier-list",icon:e.jsx(N,{size:18})},{name:"About",to:"/about",icon:e.jsx(E,{size:18})}];return e.jsxs("aside",{className:"h-screen w-60 bg-[#18181d] text-gray-200 flex flex-col p-5",children:[e.jsxs(d,{to:"/",className:"flex items-center gap-3 border-b border-gray-700 pb-4 mb-4 hover:opacity-90 transition-opacity",children:[e.jsx("img",{src:R,alt:"Stella Sora logo",className:"w-9 h-9 rounded-full object-cover"}),e.jsx("h1",{className:"text-lg font-semibold text-[#6dd3ff]",children:"Stella Sora Library"})]}),e.jsx("nav",{className:"flex flex-col gap-2",children:s.map(t=>e.jsxs(p,{to:t.to,className:({isActive:o})=>`flex items-center gap-2 px-3 py-3 rounded-md text-[15px] font-medium transition-all duration-200 ${o?"text-[#6dd3ff] bg-[#23242b]":"text-gray-300 hover:text-[#6dd3ff] hover:bg-[#23242b]"}`,children:[t.icon,t.name]},t.name))})]})}function B({children:s}){return e.jsxs("div",{className:"flex h-screen",children:[e.jsx($,{}),e.jsx("main",{className:"flex-1 p-6 overflow-y-auto",children:s})]})}const T=()=>[{title:"Stella Sora Library"},{name:"description",content:"This is an application for Stella Sora enjoyers, created because no one has made one for this game"}],A=()=>[{rel:"preconnect",href:"https://fonts.googleapis.com"},{rel:"preconnect",href:"https://fonts.gstatic.com",crossOrigin:"anonymous"},{rel:"stylesheet",href:"https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&display=swap"},{rel:"icon",type:"image/png",href:"/stella-sora-library/icons/game-icon.webp"}];function I({children:s}){return e.jsxs("html",{lang:"en",children:[e.jsxs("head",{children:[e.jsx("meta",{charSet:"utf-8"}),e.jsx("meta",{name:"viewport",content:"width=device-width, initial-scale=1"}),e.jsx(x,{}),e.jsx(u,{})]}),e.jsxs("body",{children:[s,e.jsx(f,{}),e.jsx(y,{})]})]})}const P=m(function(){const t=g(),[o,a]=l.useState(!1);return l.useEffect(()=>{if(typeof window>"u")return;const c=new URLSearchParams(window.location.search).get("redirect");if(c){const i=decodeURIComponent(c);window.history.replaceState(null,"","/stella-sora-library"+i),t(i,{replace:!0})}a(!0)},[t]),o?e.jsx(B,{children:e.jsx(j,{})}):null}),V=h(function({error:t}){let o="Oops!",a="An unexpected error occurred.",r;return b(t)&&(o=t.status===404?"404":"Error",a=t.status===404?"The requested page could not be found.":t.statusText||a),e.jsxs("main",{className:"pt-16 p-4 container mx-auto",children:[e.jsx("h1",{children:o}),e.jsx("p",{children:a}),r]})});export{V as ErrorBoundary,I as Layout,P as default,A as links,T as meta};
